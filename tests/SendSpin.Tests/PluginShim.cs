...
namespace MusicBeePlugin
{
    ...
    /// test-included plugin sources reference (its logging). The real partial class lives in
    /// MusicBeeInterface.cs + SendSpinPlugin.cs, which drag WinForms types and the MusicBee API
    /// and are not test-compilable.
    /// </summary>
